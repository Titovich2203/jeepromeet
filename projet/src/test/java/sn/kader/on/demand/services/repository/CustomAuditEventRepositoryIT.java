...
import static sn.kader.on.demand.services.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import sn.kader.on.demand.services.config.audit.AuditEventConverter;
import sn.kader.on.demand.services.domain.PersistentAuditEvent;
